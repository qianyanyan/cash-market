...
<div>
  ...
  <el-col :span="24" class="toolbar" style="padding-bottom: 0px;">
    <el-form :inline="true">
      <el-form-item>
        <el-button type="primary" @click="handleAdd"  v-if="istab == 0">新增</el-button>
      </el-form-item>
      <el-form-item>
        <el-input v-model="startDate" placeholder="请输入广告商外部ID"></el-input>
      </el-form-item>
      <el-form-item>
  ...
  <el-table ref="singleTable" :data="getAdvertisData" highlight-current-row v-loading="listLoading" style="width: 100%">
    ...
    <el-table-column property="Status" label="下线时间" v-if="istab == 1">
    </el-table-column>
    <el-table-column label="操作" width="200" align="center">
      <template scope="scope" >
                 <el-button size="small" @click="handleEdit(scope.$index, scope.row)" >查看</el-button>
                 <el-button size="small" @click="handleEdit(scope.$index, scope.row)"  v-if="istab == 0">编辑</el-button>
                 <el-button size="small" @click="handleEdit(scope.$index, scope.row)" v-if="istab == 0">下线</el-button>
            </template>
    </el-table-column>
  </el-table>
       ...
       beginDate () {
        ...
        //   点击分页
         handleSizeChange(size) {
            this.pageSize = size
            this.searchData = global.fPage(this.tableData, this.currentPage,  this.pageSize)
